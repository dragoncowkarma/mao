...
export class GithubService {
  ...
  /** Returns only the most recent issue comment, which can supersede directives in the issue body. */
  async fetchLatestIssueComment(owner: string, repo: string, issueNumber: number): Promise<string | undefined> {
    if (!this.octokit) throw new Error('GitHub token is not set')
